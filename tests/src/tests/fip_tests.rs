...
fn test_critical_if(
    ...
    // let secure_bool = SecureBool::Error;
    // fip.critical_if(
    //     || true.into(),
    //     |rng: &mut ChaChaRng| {
    //         fip.critical_write(
    ...
    //             secure_bool.ct_eq(&SecureBool::True),
    //         ))
    //     },
    //     || {
    //         writeln!(
    ...
    //         .unwrap()
    //     },
    //     || writeln!(stdout, "Error: critical-write fails").unwrap(),
    //     csprng,
    // );

    // if fip.critical_read(&secure_bool, csprng) == SecureBool::True {
